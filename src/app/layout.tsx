...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="h-full overflow-y-scroll rounded-tl-[120px] rounded-br-[120px] rounded-bl-lg rounded-tr-lg bg-paper bg-brand-vanilla border-solid border font-roboto">
        <Header />
