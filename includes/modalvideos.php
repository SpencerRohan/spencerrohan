<!-- Modal -->
<div class="modal fade" id="mvid1" tabindex="-1" role="dialog" aria-labelledby="modal-video1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="vid-1-title">Hollus - "Rally Cry" | Music Video</h5>
...
<!-- Modal -->
<div class="modal fade" id="mvid2" tabindex="-1" role="dialog" aria-labelledby="modal-video2" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="vid-2-title">Ben and Jerry's - "Super Cow" | Spot</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<!-- Modal -->
<div class="modal fade" id="mvid3" tabindex="-1" role="dialog" aria-labelledby="modal-video3" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="vid-3-title">The Latest Show Ever - Chicago Outfit | TV Pilot</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
